...
// Some implementations of parallel union-find.
// AKA disjoint-set data structure
// See Berman: Multicore
...
class CoarseUnionFind implements UnionFind {
  ...
  public synchronized int find(int x) { // with path halving
  ...
  public synchronized void union(int x, int y) { // union by rank
