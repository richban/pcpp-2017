...
\textit{Implementation in LockAccount.java}. A separate lock for every \emph{account} was implemented by having an array of lock Objects as large as the \emph{acconts}. The size of the \emph{locks} array is kept consistent with the number of \emph{accounts} - they are declared as \emph{final}. This approach results in bigger memory footprint. The reported sum might be inconsistent if during the computation of the sum, some other the previously change some of the ecounts while we're still iterating over the accounts.
...
\emph{Transfer}: Locks both accounts in a consistent order (using unique Account serial numbers) before the transfer and so is thread-safe and deadlock-free.
...
\subsection{Question 1.7.2 Stream Collect Based }

\textit{Implementation in Runner.java}
...
Experiments on \emph{BufferedPQ Ser/Serial } with different \emph{cutOff} parameters ranging from 1-4 showed similiar performance results. By increasing the \emph{bufLen=2500} and higher did not showed any significant performance improvement. This is because the sorting the arrays happens sequentialy. However the creation of the 2 recursive priority queues in the implementation of \emph{ParallelPQPair.java} showed siginificant improvements. \emph{ParallelPQPair} is 4x much faster than it's Serial implementation.
...
\begin{lstlisting}[language=java]
n 5000000  seed 3445, bufLen 1000  maxDepth 4  cutOff 4
BufferedPQ Par                 Real time:     0.922 (    0.638) extract: 5000000
BufferedPQ Par                 Real time:     0.230 (    0.090) extract: 2500000
BufferedPQ Par                 Real time:     0.154 (    0.070) extract: 1666666
BufferedPQ Par                 Real time:     0.179 (    0.121) extract: 1250000
BufferedPQ Par                 Real time:     0.122 (    0.069) extract: 1000000
BufferedPQ Par                 Real time:     0.110 (    0.071) extract: 833333
BufferedPQ Par                 Real time:     0.114 (    0.072) extract: 714285
BufferedPQ Par                 Real time:     0.159 (    0.086) extract: 625000
BufferedPQ Par                 Real time:     0.099 (    0.073) extract: 555555
BufferedPQ Par                 Real time:     0.150 (    0.117) extract: 500000
BufferedPQ Par                 Real time:     0.148 (    0.125) extract: 454545
BufferedPQ Par                 Real time:     0.098 (    0.073) extract: 416666
BufferedPQ Par                 Real time:     0.091 (    0.072) extract: 384615
BufferedPQ Par                 Real time:     0.099 (    0.075) extract: 357142
BufferedPQ Par                 Real time:     0.101 (    0.081) extract: 333333
BufferedPQ Par                 Real time:     0.131 (    0.116) extract: 312500
BufferedPQ Par                 Real time:     0.090 (    0.076) extract: 294117
BufferedPQ Par                 Real time:     0.084 (    0.070) extract: 277777
BufferedPQ Par                 Real time:     0.089 (    0.076) extract: 263157
BufferedPQ Par                 Real time:     0.146 (    0.078) extract: 250000
BufferedPQ Par                 Real time:     0.081 (    0.070) extract: 238095
BufferedPQ Par                 Real time:     0.078 (    0.068) extract: 227272
BufferedPQ Par                 Real time:     0.077 (    0.067) extract: 217391
BufferedPQ Par                 Real time:     0.130 (    0.120) extract: 208333
BufferedPQ Par                 Real time:     0.077 (    0.068) extract: 200000
BufferedPQ Par                 Real time:     0.077 (    0.068) extract: 192307
BufferedPQ Par                 Real time:     0.080 (    0.072) extract: 185185
BufferedPQ Par                 Real time:     0.074 (    0.066) extract: 178571
BufferedPQ Par                 Real time:     0.075 (    0.067) extract: 172413
\end{lstlisting}
...
The implementation of \emph{ParallelPQPair} is done by creating a thrad for each \textit{left, right PQ} recursive data structure.
